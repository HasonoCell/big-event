...
const open = async (row) => {
  ...
  if (row.id) {
    ...
    imageUrlToFile(imgUrl.value, formModel.value.cover_img)
  } else {
...
<template>
    <el-drawer v-model="visibleDrawer" :title="formModel.id ? 
    '编辑文章':'添加文章'" direction="rtl" size="50%">
        <el-form :model="formModel" ref="formRef" label-width="100px">
            ...
            <el-form-item label="文章内容" prop="content">
                <div class="editor">
                    ...
                    v-model:content="formModel.content" ref="editor"></QuillEditor>
                </div>
            </el-form-item>
            <el-form-item>
