<script setup>
import { ref } from 'vue'
import { artChangeChannelService, artAddChannelService } from '../api/article'
...
const handleSubmit = async() => {
    ...
    formModel.value.id
    ? await artChangeChannelService(formModel.value)
...
<template>
    <el-dialog v-model="dialogVisible" :title="formModel.id ? 
    '编辑分类' : '添加分类'" width="30%">
        <el-form :model="formModel" :rules="rules"
        label-width="100px" style="padding-right: 30px;" ref="formRef">
